    ...
    <section class="col-span-6 bg-white h-full shadow-xl">
      ...
      @submit.prevent="onSubmit">
        ...
        <div class="mb-4">
          ...
          class="border p-2 w-full bg-gray-50 outline-none rounded focus:ring-2 focus:ring-blue-300">
        </div>
        ...
        <div class="mb-4">
          <button type="submit" class="bg-blue-600 text-white p-2 w-full hover:bg-blue-700 rounded transition-colors divide-fuchsia-200">Masuk</button>
        </div>
